        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        <li class="active">
                            <i class="fa fa-edit"></i> MySQL Request
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <form action="request.php" method="GET">
                        <div class="form-group">
                            ...
                            <select name="database">
                                ...
                                {
                                    ?>
                                    <option value="<?php echo $db->db_name() ?>"><?php echo $db->db_name() ?></option>
                                    <?php
                                }
                                ?>
                            </select>
                            <br>
                            <label>REQUEST :</label>
                            <textarea name="sql" class="form-control" rows="2" cols="80"></textarea>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="alert alert-info alert-dismissable">
                        ...
                        <table class="table table-bordered table-hover table-striped">
                            <thead>
                            <tr>
                                <?php foreach (array_keys($data3[0]) as $th_row)
                                {
                                    ?>
                                    <th><?php echo $th_row ?></th>
                                    <?php
                                }
                                ?>
                            </tr>
                            ...
                            <?php foreach ($data3 as $row) { ?>
                                <tr>
                                    <?php foreach ($row as $td_row) {?>
                                        <td><?php  echo $td_row ?></td>
                                    <?php } ?>
                                </tr>
                                <?php } ?>
                            </tbody>
