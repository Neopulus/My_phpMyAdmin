            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-header">
                        ...
                        <h5>Edition des champs de la table <?php echo $table ?></h5>
                    </div>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li>
                            <i class="fa fa-pencil"></i> <?php echo $table ?>
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-lg-5">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                        <?php
                        foreach($data->ListElem($table) as $el)
                        {
                            ?>
                            <tr>
                                <td><?php echo $el[0] ?></td>
                ...
                <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#add">Ajouter un élement<i class="fa fa-plus fa-2x"></i></button>
                <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#rename">Renommer un élement<i class="fa fa-pencil fa-2x"></i></button>
                <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete">Supprimer un élement<i class="fa fa-times fa-2x"></i></button>
            </div>
        </div>
        <!-- /.container-fluid -->
    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Editer : Element</h4>
                </div>
                <div class="modal-body">
                    <form action="myadmin.php" method="post">
                        <input type="hidden" name="function" value="edit_el" />
                        <input type="hidden" name="database" value="<?php echo $data->getDbname(); ?>" />
                        <input type="hidden" name="table" value="<?php echo $table ?>" />
                        <label>Nom de l'élement à éditer :</label>
    ...
    <div id="delete" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Supprimer : Element</h4>
                </div>
                <div class="modal-body">
                    <p><i class="fa fa-exclamation-triangle"></i>Une fois supprimé, toutes les valeurs associées seront irrécuperable</p>
                    <form action="myadmin.php" method="post">
                        <input type="hidden" name="function" value="delete_el" />
                        <input type="hidden" name="database" value="<?php echo $data->getDbname(); ?>" />
                        <input type="hidden" name="table" value="<?php echo $table ?>" />
                        <label>Nom de l'élement à supprimer :</label>
                        <input type="text" name="el">
                        <hr>
    ...
    <div id="add" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Ajout : Element</h4>
                </div>
                <div class="modal-body">
                    <form action="myadmin.php" method="post">
                        <input type="hidden" name="function" value="add_el" />
                        <input type="hidden" name="database" value="<?php echo $data->getDbname(); ?>" />
                        <input type="hidden" name="table" value="<?php echo $table ?>" />
                        <label>Nom du nouveau élement :</label>
                        <input type="text" name="el">
                        <br>
                        <label>Type de l'élement :</label>
                        <select name="type">
                            <option value="INTEGER">int (4octets)</option>
                            <option value="CHAR(255)">char* (max. 255octets)</option>
                            <option value="DATE">date (3octets)</option>
